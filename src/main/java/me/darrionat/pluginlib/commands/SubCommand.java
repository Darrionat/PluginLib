...
/**
 * The {@link SubCommand} represents a command that has arguments. SubCommands
 * require to be within a parent command, {@link BaseCommand}.
 * 
...
public abstract class SubCommand {
	 ...
	 * {@link BaseCommand}'s subcommands.
	 * 
	 ...
	 * 
	 * @return Returns the {@link BaseCommand} that this {@link SubCommand} belongs
	 *         to.
	 */
	...
	/**
	 * Ran when the parent {@link BaseCommand} is run and if it implements the
	 * {@link HeritableCommand} interface and has this {@link SubCommand}.
	 * 
	 * @param sender The person who ran the command.
	 * @param args   The arguments of the command.
	 *               {@link SubCommand#getSubCommand()} will always be equal to
	 *               {@code args[0]}
	 */
	 ...
	 * 
	 * @return Returns an amount of arguments that is required for the command to be
	 *         ran. This amount includes the {@link SubCommand} itself as an
	 *         argument.
	 * @see #getSubCommand()
	 */
	...
	/**
	 * Gets if the {@link SubCommand} can be ran by {@link CommandSender}s that are
	 * not {@link Player}s.
	 * 
